...
const Post = ({ subG, posts, userDetails }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios.put(
      `http://localhost:5000/mySubGreddiit/handleReports/${subG._id}`,
      reportData
    );
  };
  return loader.length > 0 && loader2.length > 0 ? (
    <div class="card">
      <div class="card-body">
        <div class="row">
        ...
        <div>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end" }}>
            <ReportIcon
              ...
              data-bs-target={`#createReport${posts}`}
            />
            <div
              class="modal fade"
              id={`createReport${posts}`}
              tabindex="-1"
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setReportData({
                            ...
                            reportedUser: postedby._id,
                            reportedBy: userDetails._id,
                          })
                        }
                      />
                      <input
                        className="post_text"
                        type="text"
                        placeholder="Select Text From the above post"
                        id="text"
                        name="text"
                        autofocus
                        onChange={(e) =>
